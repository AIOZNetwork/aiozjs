...
export {
  ...
  extractSecp256k1HdWalletKdfConfiguration,
  extractSecp256k1WalletKdfConfiguration,
  extractEthSecp256k1HdWalletKdfConfiguration,
  extractEthSecp256k1WalletKdfConfiguration,
  executeKdf,
  makeCosmoshubPath,
  makeSignDoc,
  parseCoins,
