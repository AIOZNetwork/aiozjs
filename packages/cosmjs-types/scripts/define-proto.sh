...
echo "Processing aiozd proto files ..."
AIOZD_DIR="./proto"
WASMD_THIRD_PARTY_DIR="./wasmd-0.18/third_party/proto"
protoc \
  --plugin="$PLUGIN_PATH" \
  ...
  --proto_path="$WASMD_THIRD_PARTY_DIR" \
  --ts_proto_yarn_2_opt="esModuleInterop=true,forceLong=long,useOptionals=true" \
  "$AIOZD_DIR/ethermint/crypto/v1/ethsecp256k1/keys.proto" \
  "$AIOZD_DIR/ethermint/evm/v1/evm.proto" \
  "$AIOZD_DIR/ethermint/evm/v1/genesis.proto" \
  "$AIOZD_DIR/ethermint/evm/v1/query.proto" \
  "$AIOZD_DIR/ethermint/evm/v1/tx.proto" \
  "$AIOZD_DIR/ethermint/feemarket/v1/feemarket.proto" \
  "$AIOZD_DIR/ethermint/feemarket/v1/genesis.proto" \
  "$AIOZD_DIR/ethermint/feemarket/v1/query.proto" \
  "$AIOZD_DIR/ethermint/types/v1/account.proto" \
  "$AIOZD_DIR/ethermint/types/v1/web3.proto" \
