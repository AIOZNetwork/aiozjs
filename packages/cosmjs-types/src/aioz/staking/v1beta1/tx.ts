...
export const MsgProposeValidator = {
  encode(message: MsgProposeValidator, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgProposeValidator {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: MsgProposeValidator): unknown {
    const obj: any = {};
    message.authority !== undefined && (obj.authority = message.authority);
...
export const MsgProposeValidatorResponse = {
  encode(_: MsgProposeValidatorResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgProposeValidatorResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(_: MsgProposeValidatorResponse): unknown {
    const obj: any = {};
    return obj;
  },
...
export class MsgClientImpl implements Msg {
  ...
  ProposeValidator(request: MsgProposeValidator): Promise<MsgProposeValidatorResponse> {
    ...
    return promise.then((data) => MsgProposeValidatorResponse.decode(new _m0.Reader(data)));
  }
}
