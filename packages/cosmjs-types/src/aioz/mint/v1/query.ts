...
import { Params } from "../../../aioz/mint/v1/mint";
...
const baseQueryAnnualInflationRequest: object = {};
...
export const QueryAnnualInflationRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAnnualInflationRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryAnnualInflationRequest } as QueryAnnualInflationRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(_: DeepPartial<QueryAnnualInflationRequest>): QueryAnnualInflationRequest {
    const message = { ...baseQueryAnnualInflationRequest } as QueryAnnualInflationRequest;
    return message;
  },
};

const baseQueryAnnualInflationResponse: object = {};
...
export const QueryAnnualInflationResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAnnualInflationResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryAnnualInflationResponse } as QueryAnnualInflationResponse;
    message.annualInflation = new Uint8Array();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryAnnualInflationResponse {
    const message = { ...baseQueryAnnualInflationResponse } as QueryAnnualInflationResponse;
    message.annualInflation = new Uint8Array();
    if (object.annualInflation !== undefined && object.annualInflation !== null) {
      message.annualInflation = bytesFromBase64(object.annualInflation);
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<QueryAnnualInflationResponse>): QueryAnnualInflationResponse {
    const message = { ...baseQueryAnnualInflationResponse } as QueryAnnualInflationResponse;
    if (object.annualInflation !== undefined && object.annualInflation !== null) {
      message.annualInflation = object.annualInflation;
    } else {
      message.annualInflation = new Uint8Array();
    }
    return message;
