...
const baseExtensionOptionsWeb3Tx: object = { typedDataChainId: Long.UZERO, feePayer: "" };
...
export const ExtensionOptionsWeb3Tx = {
  ...
  fromJSON(object: any): ExtensionOptionsWeb3Tx {
    ...
    if (object.typedDataChainId !== undefined && object.typedDataChainId !== null) {
      message.typedDataChainId = Long.fromString(object.typedDataChainId);
    } else {
  ...
  fromPartial(object: DeepPartial<ExtensionOptionsWeb3Tx>): ExtensionOptionsWeb3Tx {
    const message = { ...baseExtensionOptionsWeb3Tx } as ExtensionOptionsWeb3Tx;
    if (object.typedDataChainId !== undefined && object.typedDataChainId !== null) {
      message.typedDataChainId = object.typedDataChainId as Long;
    } else {
      message.typedDataChainId = Long.UZERO;
    }
    if (object.feePayer !== undefined && object.feePayer !== null) {
